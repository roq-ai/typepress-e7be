...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'content.count', 'plugin.count', 'template.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('plugin', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>plugin</Th>}
