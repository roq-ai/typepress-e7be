...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['site-owner', 'content-creator', 'site-administrator', 'developer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Plugin', path: '/plugins', entity: 'plugin', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Template', path: '/templates', entity: 'template', service: AccessServiceEnum.PROJECT, icon: FiLayout },
